<template>
    <div>
        <h2 style="text-align: center">html5拖拽布局示例</h2>
        <div class="box"
             @drop="drop($event)"
        ...
        <div class="btn-area">
            <a-button style="margin-right: 20px"
                      :draggable="true"
                      @dragstart="dragStart($event,item.link)"
...
export default {
    data() {
        return {
            collectionButtons: [
                {name: '藏品1', link: pic1, disabled: false},
                {name: '藏品2', link: pic2, disabled: false},
                {name: '藏品3', link: pic3, disabled: false},
                {name: '藏品4', link: pic4, disabled: false},
            ],
            collectionPics: [
                // {
                //     url:'',
